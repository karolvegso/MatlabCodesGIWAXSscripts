...
% then takes qr-cuts (horizontal cuts along qr axis) 
% integrated in qz interval
%**************************************************************************
% path to folder with images
path_to_input_folder='d:\Pilatus_images\';
% path to folder with result qr cuts matrix
...
%**************************************************************************
% linecut parameters - horizontal cut along qr axis
%**************************************************************************
% number of qr points to cut
no_of_qr_points=300;
% qr - minimum limit
qr_min=-0.33; % [A^(-1)]
% qr - maximum limit
...
for index_0=no_image_start:time_binning:no_image_stop
    ...
    % define constraint
    constr = [1 3 qz_min qz_max; 1 6 qr_min qr_max]; 
    % perform linecut
    xflag = 6; % qr linecut
    nofpts = no_of_qr_points; % number of points in the linecut
...
% save qr-cuts (horizontal cuts along qr axis) matrix
