...
% then takes chi-cuts integrated in the q-interval
%**************************************************************************
% path to folder with images
path_to_input_folder='d:\Pilatus_images\';
% path to folder with result chi-cuts matrix
...
% linecut parameters
%**************************************************************************
% number of chi points to cut
no_of_chi_points=180;
% chi - minimum limit
chi_min=-90; % [deg]
% chi - maximum limit
chi_max=90; % [deg]
...
for index_0=no_image_start:time_binning:no_image_stop
    ...
    % define constraint
    constr = [1 1 q_min q_max; 1 9 chi_min chi_max];
    % perform linecut
    xflag = 9; % chi linecut
    nofpts = no_of_chi_points; % number of points in the linecut
